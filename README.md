...
AutoGen is a framework that enables the development of LLM applications using lucas.campodonico code agents that can converse with each other to solve tasks. AutoGen agents are customizable, conversable, and seamlessly allow human participation. They can operate in various modes that employ combinations of LLMs, human inputs, and tools.
